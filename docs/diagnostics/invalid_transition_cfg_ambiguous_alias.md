# Transition Cfg Ambiguous Alias

Status: first-party diagnostic

Source fixture: `../../statum-macros/tests/ui/invalid_transition_cfg_ambiguous_alias.rs`
Compiler-output fixture: `../../statum-macros/tests/ui/invalid_transition_cfg_ambiguous_alias.stderr`
...
error: Error: transition method `Machine<Draft>::maybe_accept` returns an unsupported type.
  ...
  --> tests/ui/invalid_transition_cfg_ambiguous_alias.rs:30:30
   |
30 |     fn maybe_accept(self) -> Maybe<Machine<Accepted>> {
   |                              ^^^^^
```
