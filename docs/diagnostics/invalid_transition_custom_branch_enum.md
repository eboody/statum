# Transition Custom Branch Enum

Status: first-party diagnostic

Source fixture: `../../statum-macros/tests/ui/invalid_transition_custom_branch_enum.rs`
Compiler-output fixture: `../../statum-macros/tests/ui/invalid_transition_custom_branch_enum.stderr`
...
error: Error: transition method `Machine<Draft>::decide` returns an unsupported type.
       Found: `fn decide(self) -> Decision<Machine<Accepted>, Machine<Rejected>>`
       ...
       Primary branch: `Decision<Machine<Accepted>, Machine<Rejected>>`
  ...
  --> tests/ui/invalid_transition_custom_branch_enum.rs:30:38
   |
30 |     fn decide(self, accept: bool) -> Decision<Machine<Accepted>, Machine<Rejected>> {
   |                                      ^^^^^^^^
```
