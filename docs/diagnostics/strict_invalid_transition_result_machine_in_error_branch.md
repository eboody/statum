...
Source fixture: `../../statum-macros/tests/ui/strict_invalid_transition_result_machine_in_error_branch.rs`
Compiler-output fixture: `../../statum-macros/tests/ui/strict_invalid_transition_result_machine_in_error_branch.stderr`
...
error: Error: transition method `Machine<Draft>::finish` returns an unsupported type.
  ...
  --> tests/ui/strict_invalid_transition_result_machine_in_error_branch.rs:24:24
   |
