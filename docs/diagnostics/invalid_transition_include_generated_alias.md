# Transition Include Generated Alias

Status: first-party diagnostic

Source fixture: `../../statum-macros/tests/ui/invalid_transition_include_generated_alias.rs`
Compiler-output fixture: `../../statum-macros/tests/ui/invalid_transition_include_generated_alias.stderr`
...
include!("support/transition_alias_include.rs");
...
error: Error: transition method `Machine<Draft>::maybe_accept` returns an unsupported type.
       Found: `fn maybe_accept(self) -> Maybe<Machine<Accepted>>`
       ...
       Primary branch: `Maybe<Machine<Accepted>>`
  ...
  --> tests/ui/invalid_transition_include_generated_alias.rs:26:30
   |
26 |     fn maybe_accept(self) -> Maybe<Machine<Accepted>> {
   |                              ^^^^^
```
