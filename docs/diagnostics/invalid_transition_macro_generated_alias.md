# Transition Macro Generated Alias

Status: first-party diagnostic

Source fixture: `../../statum-macros/tests/ui/invalid_transition_macro_generated_alias.rs`
Compiler-output fixture: `../../statum-macros/tests/ui/invalid_transition_macro_generated_alias.stderr`
...
error: Error: transition method `Machine<Draft>::maybe_accept` returns an unsupported type.
  ...
  --> tests/ui/invalid_transition_macro_generated_alias.rs:32:30
   |
32 |     fn maybe_accept(self) -> Maybe<Machine<Accepted>> {
   |                              ^^^^^
```
